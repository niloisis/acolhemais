...
export default function LoginApp() {
  ...
  const onSubmit = async (data: LoginSchema) => {
    try {
      ...
      if(ongId) await localStorage.setItem("ongId", ongId);
    ...
    <div className="min-h-screen bg-gray-50 relative overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 flex-1 px-6 flex flex-col w-full max-w-md mx-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3 bg-transparent">
          ...
          {/* Opções Extras (Lembrar/Esqueci) - Mantido menor como pedido */}
        ...
        <div className="flex flex-row items-center justify-center mt-auto mb-8 gap-1 text-sm">
            <span className="text-gray-900 font-regular">Gostaria de se cadastrar?</span>
            ...
            <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
              ...
              <DialogContent className="fixed left-[50%] top-[50%] z-50 w-[88%] max-w-md translate-x-[-50%] translate-y-[-50%] rounded-2xl bg-white border-none p-6 shadow-lg gap-4">
    
                <DialogHeader>
                    <DialogTitle className="text-xl font-regular text-center text-gray-700">
                        Escolha seu perfil
                    </DialogTitle>
